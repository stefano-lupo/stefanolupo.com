...
<html lang="en">
	...
	<head>
		...
		<!-- SEO -->
		<title>Stefano Lupo Webdesign - About Me</title>
		<meta name="description" content="Stefano Lupo Web Design - About me, proficient languages, experience">
			...
			<div class="container-fluid">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-left nav-links-bg">
						<li>
							<a href="about-me.php" class="current-page">About Me</a>
						</li>
						<li>
			...
			<div class="row equal">
				<div class="col-md-4">
					<div class="card">
						...
						<hr>
						<p>
							HTML 5 is a markup language in which websites are built. All of the code to create and display your web page, along with any static content you wish to include is done so through HTML.
						</p>
					</div>
				</div>
				<div class="col-md-4">
			...
			<div class="row equal">
				...
				<div class="col-md-4">
					<div class="card">
						...
						<hr>
						<p>
							MySQL works in tandom with php. As mentioned, modern day webpages revolve around dynamic content which is stored in a database and programatically (conditionally) called upon. MySQL is the language used to manage, retreive and add content (text/images etc) to and from your database!
						</p>
					</div>
				</div>
			</div>
